...
//		case 's': stereo ^= 1, eyes = 10;break;
		...
		case '=': _meshManager.Scale(0.1); break;
		case '-': _meshManager.Scale(-0.1); break;
		case '1': _meshManager.SwitchMesh(key); PlaySound("click.wav"); break;
		case '2': _meshManager.SwitchMesh(key); PlaySound("click.wav"); break;
		case '3': _meshManager.SwitchMesh(key); PlaySound("click.wav"); break;
		case '4': _meshManager.SwitchMesh(key); PlaySound("click.wav"); break;
		case '5': _meshManager.SwitchMesh(key); PlaySound("click.wav"); break;
		case '6': _meshManager.SwitchMesh(key); PlaySound("click.wav"); break;
...
//	_render.DrawPolygon(points);
	...
	std::cout << "Mesh Name: " << _meshManager.meshName_ << " FPS: " << static_cast<int>(fps) << "\n";
